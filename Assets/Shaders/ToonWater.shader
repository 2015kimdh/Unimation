Shader "Roystan/Toon/Water"
{
    ...
    {	
		...
		_FoamGradientShallow("Foam Depth Gradient Shallow", Color) = (0.325, 0.807, 0.971, 0.8)
		_FoamGradientDeep("Foam Depth Gradient Deep", Color) = (0.086, 0.407, 1, 0.8)
    ...
    SubShader
    {
		...
		float4 alphaBlend(float4 top, float4 bottom)
		{
			...
			float4 _FoamGradientShallow;
			float4 _FoamGradientDeep;
			float4 _FoamColor;
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				float4 foamColor = lerp(_FoamGradientShallow, _FoamGradientDeep, foamDepthDifference01);
				...
				//float surfaceNoise = surfaceNoiseSample > surfaceNoiseCutoff ? foamColor : 0;
